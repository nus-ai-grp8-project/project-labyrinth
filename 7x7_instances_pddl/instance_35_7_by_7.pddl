(define (problem labyrinth-size-7-rotations-4-seed-35)
(:domain labyrinth)
(:objects
...
(:init
	...
	(card-at card37 pos0 pos5)
	(card-at card38 pos1 pos5)
	(card-at card39 pos2 pos5)
	(card-at card40 pos3 pos5)
	(card-at card41 pos4 pos5)
	(card-at card35 pos5 pos5)
	(card-at card36 pos6 pos5)
