(define (problem labyrinth-size-7-rotations-4-seed-34)
(:domain labyrinth)
(:objects
...
(:init
	...
	(card-at card35 pos2 pos5)
	(card-at card36 pos3 pos5)
	(card-at card37 pos4 pos5)
	(card-at card38 pos5 pos5)
	(card-at card32 pos6 pos5)
